...
export class CallXCallStatusController {
  constructor(private readonly callXCallStatusService: CallXCallStatusService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCallXCallStatusDto: UpdateCallXCallStatusDto) {
